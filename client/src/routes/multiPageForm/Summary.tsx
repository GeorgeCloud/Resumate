  ...
  return (
    <div className="page">
      ...
      <div className="max-w-xs w-full mx-auto text-sm flex flex-col items-start justify-start mt-4 ml-24 text-left">
        <h3 className="text-center font-normal underline underline-offset-1 decoration-1 text-base mb-4">Personal Data</h3>
        ...
        <h3 className="text-center font-normal underline underline-offset-1 decoration-1 text-base mb-4">Education Data</h3>
        ...
        <h3 className="text-center font-normal underline underline-offset-1 decoration-1 text-base mb-4">Professional Data</h3>
        ...
        <h3 className="text-center font-normal underline underline-offset-1 decoration-1 text-base mb-4">Projects Data</h3>
